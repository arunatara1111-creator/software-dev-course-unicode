...
//Starter Code
// Task 1
let inputString1 = "Code";//extract two code points
...
let swappedString=String.fromCharCode(inputString2.charCodeAt(inputString2.length-1))+inputString2.slice(1,inputString2.length-2)+String.fromCharCode(inputString2.charCodeAt(0)); // Your code here
